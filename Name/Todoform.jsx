...
const Todoform = ()=>{
    ...
    const Validate = (values)=>{
        ...
        if(!values.status){
            error.status.Progess.Done='Please choose any status!'
        }
                    ...
                    <form method='post' onSubmit={submitHandler}>
                        ...
                        <div className='mb-3'>
                            <div className=' d-md-flex align-items-center radio-status'>
                              ...
                              <div>  <input type='radio' name='status' className='form-check-input ml-5'  value='Planned'
                                onChange={changeHandler}/> Planned
                                </div>
                                <div><input type='radio' name='status' className='form-check-input ml-5' value='In-Progress'
                                onChange={changeHandler}/> In-Progress
                                </div>
                               <div><input type='radio' name='status' className='form-check-input ml-5'  value='Done'
