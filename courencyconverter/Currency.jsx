...
import Currencyop from './Currencyop';
const Currency = () => {
    ...
    <div className='container'>
        <div className='grid-container'>
            ...
            <div className='grid-item2'>
                ...
                <Currencyop currencyOptions={currencyOptions} prop='from currency'
            ...
            <div className='grid-item3'>
                ...
                <Currencyop currencyOptions={currencyOptions} prop='to currency'
